...
public class GMailerUtils {
    ...
    private static Credential getCredentials(final NetHttpTransport httpTransport, GsonFactory jsonFactory)
            throws IOException {
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(jsonFactory, new InputStreamReader(GMailerUtils.class.getResourceAsStream("/client_secret_374793696744-cvn8qi8nj0rkpf0rtnpf4s7c3nslc8v1.apps.googleusercontent.com.json")));
